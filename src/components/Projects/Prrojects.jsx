...
export const Projects = () => {
  ...
  return (
    <section className="py-16 min-h-screen bg-gradient-to-b from-gray-900 to-black" id="projects">
      <div className="container mx-auto px-4">
        <h2 className="text-white text-4xl font-bold tracking-wider uppercase text-center mb-12">Projects</h2>
        <div className="relative min-h-[500px] md:h-[70vh] w-full overflow-hidden rounded-xl">
          ...
          <button
            className="absolute top-1/2 left-4 transform -translate-y-1/2 bg-white/10 hover:bg-white/20 transition-colors rounded-full p-2 text-white"
            onClick={prevSlide}
          ...
          <button
            className="absolute top-1/2 right-4 transform -translate-y-1/2 bg-white/10 hover:bg-white/20 transition-colors rounded-full p-2 text-white"
            onClick={nextSlide}
